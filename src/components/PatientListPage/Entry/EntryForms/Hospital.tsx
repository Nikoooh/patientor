...
const HospitalForm = ({setType, healthCheckFormRef, handleNewEntry, diagnoses, entryDiagnoses, setEntryDiagnoses}: EntryFormProps): JSX.Element => {
  ...
  return (
    <form onSubmit={handleNewEntry} style={{marginTop: '20px', borderTop: '1px solid rgba(192,192,192,0.4)', borderRadius: '2px', outline: 'none'}} ref={healthCheckFormRef}>
      <Typography sx={{mt: 2}} variant="h5">Type: Hospital</Typography>
      ...
      <Typography variant="h6" sx={{mt: 2}}> Discharge </Typography>      
      <div style={{overflow: 'hidden', padding: '20px'}}>      
        <Typography variant="h6" sx={{mt: 2, fontSize: '1rem'}}> Date </Typography>  
        <input style={{marginTop: '5px', width: '100%', height: '30px', border: 0, borderBottom: '1px solid rgba(100, 100, 100, 0.2)'}} name="dischargeDate" type="date"/>
        <Typography variant="h6" sx={{mt: 2, fontSize: '1rem'}}> Criteria </Typography>  
        <input style={{marginTop: '5px', width: '100%', height: '30px', border: 0, borderBottom: '1px solid rgba(100, 100, 100, 0.2)'}} name="criteria" type="text"/>     
      </div> 
